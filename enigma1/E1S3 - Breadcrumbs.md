...
you simply are storing off how much the value is away from an _**implicitly**_ reproducible point one bit 
...
data can sometimes _stall._  I have a solution for this condition, but it does so by modulating the pathway - which
one could argue negates my point.  I'll leave that for you to decide, for now I provide a conjecture -
