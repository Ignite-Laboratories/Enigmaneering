...
Now that we've established the general _concept_ of manifestation through neural signals - _synthesis_ - it's time to begin
_utilizing_ it!

My first challenge has been to synthesize a _file_ from the smallest seed value possible.  There are a surprising
number of ways to do this - so many so that it's shocking we _haven't_ yet, as I've metaphorically been "stumbling" 
over them.

The rub isn't that it's _hard_ - it's just hard to do it _reliably._

That's because of the below graph of the magnitude necessary to _**distinguish**_ a potential relative to the midpoint 
of _**all**_ indexes

[Insert index compressibility chart here]
...
At this point, we're going to begin evolving our signals into _**notes!**_
    ...
    tl;dr - indexes have an ideal range of potential compressibility defined under an exponential bell curve
      ...
      why - its binary representation grows logarithmically as the magnitude increases