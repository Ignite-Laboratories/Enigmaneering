...
**Passages** - A passage is a _logical transformation_ of binary information (we'll get to that shortly.)

**Movements** - A movement is a collection of passages, allowing concurrent processing.
...
**Super Byte Measurements** - A super-measurement is any bit range greater than 8 bits wide.  I almost _never_ 
